...
import { Align, BarcodeOptions, BarcodeType, CashDrawerPin, Printer, QRCodeOptions, TextFont, TextSize, TextUnderline } from './Printer';
...
export declare abstract class BasePrinter implements Printer {
    protected cmds: Cmd[];
